...
#
# Lab4.tcl: Tcl script for re-creating project 'Lab5'
#
# Generated by Vivado on Fri Oct 14 13:30:52 PDT 2022
...
#
#    "/home/troy/fa22-e524-lab4-troykerim/hardware/Lab5/Lab5.srcs/utils_1/imports/synth_1/top.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/troy/fa22-e524-lab4-troykerim/hardware/ip_repo/clk_wiz_0/clk_wiz_0.xci"
#    "/home/troy/520_lab5_cora_files/Cora-Z7/hw/src/hdl/top.vhd"
#    "/home/troy/Downloads/Zybo-Z7-Master.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/Lab5/Lab5.srcs/utils_1/imports/synth_1/top.dcp"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/../../520_lab5_cora_files/Cora-Z7/hw/src/hdl/top.vhd"]"\
 "[file normalize "$origin_dir/../../Downloads/Zybo-Z7-Master.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set_property -name "customized_default_ip_location" -value "/home/troy/fa22-e524-lab4-troykerim/hardware/ip_repo" -objects $obj
...
set file "$origin_dir/../../520_lab5_cora_files/Cora-Z7/hw/src/hdl/top.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize "$origin_dir/../../Downloads/Zybo-Z7-Master.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../Downloads/Zybo-Z7-Master.xdc"
set file [file normalize $file]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/Lab5.srcs/utils_1/imports/synth_1/top.dcp" -objects $obj
